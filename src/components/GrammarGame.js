...
<parameter name="id">grammar-game-with-hub-link</parameter>
<parameter name="type">application/vnd.ant.code</parameter>
<parameter name="title">GrammarGame with Syntactic Hub Link</parameter>
<parameter name="command">create</parameter>
<parameter name="content">// src/components/GrammarGame.js
